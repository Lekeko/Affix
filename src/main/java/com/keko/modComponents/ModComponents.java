...
public class ModComponents {
    ...
    public static final DataComponentType<Float> MIRROR_POSITION_TRANSITION = register("MIRROR_POSITION_TRANSITION_ID".toLowerCase(), floatBuilder -> floatBuilder.persistent(Codec.FLOAT));
